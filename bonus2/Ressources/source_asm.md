...
Dump of assembler code for function main:
   ...
   0x08048538 <+15>:    cmpl   $0x3,0x8(%ebp)               <==== CMP
   0x0804853c <+19>:    je     0x8048548 <main+31>          <==== JUMP
   0x0804853e <+21>:    mov    $0x1,%eax
   0x08048543 <+26>:    jmp    0x8048630 <main+263>        <==== JUMP
   ...
   0x080485dd <+180>:   jne    0x80485eb <main+194> <====== if lang == fi jumps
   0x080485df <+182>:   movl   $0x1,0x8049988        <============== move 1 into var language
   0x080485e9 <+192>:   jmp    0x8048618 <main+239> <==== then jumps
   0x080485eb <+194>:   movl   $0x2,0x8(%esp)      <=== so if 
   0x080485f3 <+202>:   movl   $0x8048740,0x4(%esp)   <=========== 0x8048740 = "ni"
   0x080485fb <+210>:   mov    0x9c(%esp),%eax 
   0x08048602 <+217>:   mov    %eax,(%esp)
   0x08048605 <+220>:   call   0x8048360 <memcmp@plt>
   0x0804860a <+225>:   test   %eax,%eax
   0x0804860c <+227>:   jne    0x8048618 <main+239>
   0x0804860e <+229>:   movl   $0x2,0x8049988      <============== move 2 into var language
...
Dump of assembler code for function greetuser:
   ...
   0x0804848a <+6>:     mov    0x8049988,%eax    ===> 0x8049988 = var language
   0x0804848f <+11>:    cmp    $0x1,%eax
   0x08048492 <+14>:    je     0x80484ba <greetuser+54> <== if lang = 1 jumps to 54
   0x08048494 <+16>:    cmp    $0x2,%eax
   0x08048497 <+19>:    je     0x80484e9 <greetuser+101> <==  jump if lang = 2 = ni
   ...
   0x08048509 <+133>:   nop
   0x0804850a <+134>:   lea    0x8(%ebp),%eax  ==> argv1 in ebp+8
   0x0804850d <+137>:   mov    %eax,0x4(%esp) 
   0x08048511 <+141>:   lea    -0x48(%ebp),%eax ==> 48 = 72 ce qui explique l'output de 72 char max
   0x08048514 <+144>:   mov    %eax,(%esp)
   0x08048517 <+147>:   call   0x8048370 <strcat@plt>
   0x0804851c <+152>:   lea    -0x48(%ebp),%eax ==> 48 = 72 ce qui explique l'output de 72 char max
...
Also a uninitialized var called:

08049988 <language>:
 8049988:       00 00                   add    %al,(%eax)
        ...
